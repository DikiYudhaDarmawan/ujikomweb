...
@section('content')
<!-- Hero Section -->
<section class="hero-section position-relative d-flex align-items-center" style="background: url('{{ asset('assets/foto/banner.png') }}') no-repeat center center; background-size: cover; height: 600px;">
  ...
  <div class="container position-relative">
    <div class="row align-items-center">
      <div class="col-md-6 text-white">
        ...
        <p class="lead mb-4">
          Nikmati kemudahan dalam mengelola kegiatan ekstrakurikuler. Temukan ekskul yang sesuai minatmu dan raih prestasi terbaik!
        </p>
        <a href="#ekskul" class="btn btn-primary btn-lg shadow">Lihat Ekskul</a>
      </div>
      <div class="col-md-6 text-center">
        <img src="{{ asset('assets/foto/fotoekskul.jpeg') }}" alt="Ilustrasi Ekskul" class="img-fluid rounded shadow" style="max-height: 400px;">
      </div>
    </div>
  </div>
</section>
          ...
          <div class="card h-100 border-0 shadow-sm">
            @if ($data->foto)
              <div class="position-relative">
                <img src="{{ asset('image/logoekskul/' . $data->foto) }}" class="card-img-top" alt="{{ $data->name }}" style="height: 220px; object-fit: cover;">
            ...
            @else
              <img src="{{ asset('assets/foto/noimage.jpeg') }}" class="card-img-top" alt="Default Image" style="height: 220px; object-fit: cover;">
            @endif
